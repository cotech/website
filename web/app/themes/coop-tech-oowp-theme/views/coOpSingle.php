            ...
            <div class="small-12 large-8 columns">
                ...
                <?php if ($post->people()->posts):
                    ...
                    <section>
                        ...
                        <table>
                            <tr>
                                <th rowspan="2">Name</th><th rowspan="2">Experience</th><th rowspan="2">Skills</th><th colspan="3">Availability (days)</th>
                                <th rowspan="2">Min (cost) rate</th>
                                <th rowspan="2">Standard commercial rate</th>
                            </tr>
                            <tr><th>Next 5</th><th>Next 30</th><th>Next 90</th></tr>
